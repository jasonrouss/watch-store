    ...
    <footer className="footer mt-4 bg-neutral-900">
      ...
      <div className="flex mx-2 justify-center icons">
        <div className=" flex mt-8 text-4xl gap-20">
          ...
          <a className="text-sky-700" href="https://www.linkedin.com/in/jason-rouss-7a8129190/">
              <FaLinkedin/>
          </a>
      ...
      {/* Copyright */}
      <div className="copyright flex justify-center text-slate-400 pb-4 pt-4">Jason Rouss Ⓒ 2021-2022</div>
    </footer>
  );
};
