...
const Customer = () => {
  return (
    <div className="title text-2xl  mt-6 mt-4 ">
      ...
      <div className="customer1 transition transform  hover:-translate-y-2 motion-reduce:transition-none motion-reduce:transform-none shadow-xl flex md:justify-start m-4  rounded-xl border border-stone-400">
        <img
          src={woman}
          alt="customer 1"
      ...
      <div className="customer2 transition transform  hover:-translate-y-2 motion-reduce:transition-none motion-reduce:transform-none shadow-xl  mt-6 flex md:justify-start m-4  rounded-xl border border-stone-400">
        <img
          src={man}
          alt="customer 2"
      ...
      <div className="customer3 transition transform  hover:-translate-y-2 motion-reduce:transition-none motion-reduce:transform-none  shadow-xl   mt-6 flex   md:justify-start m-4  rounded-xl border border-stone-400">
        <img
          src={woman2}
          alt="customer 3"
